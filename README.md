...
This project implements high-performance numerical computing functions (floating-point array sum, max value, and sorting) using various acceleration techniques including **SIMD (AVX instructions)**, **multi-threading (OpenMP)**, and **distributed computing via TCP protocol**.

The goal is to maximize computational performance by leveraging the combined processing power of two networked computers.
...
- ⚠️ Note: Network communication overhead is significant for this data size
...
- The initial data is sequentially ordered, which affects algorithm selection (merge sort preferred over quicksort to avoid O(n²) worst case)
...
<p align="center">
  <i>Built with ❤️ using AVX, OpenMP, and TCP</i>
</p>
